...
// depthMask = TRUE stops depth buffering from working correctly - not sure why, since it is the default value
//    gl.depthMask(gl.TRUE);
  ...
  function display() {
    ...
    ext.bindVertexArrayOES(vertexArray1);
    gl.uniform3f(offset, 0.0, 0.0, 0.5);
